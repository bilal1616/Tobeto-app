...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final TextEditingController _emailController = TextEditingController(); // Kayıt için e-posta
        ...
        children: [
          ...
          Center(
            child: Container(
              ...
              height: MediaQuery.of(context).size.height * 0.62, // Konteyner boyutu
              decoration: BoxDecoration(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: MediaQuery.of(context).size.height * 0.02), // Boşluk ekleme
                      _isRegisterScreen
                          ? TextField(
                      ...
                      SizedBox(height: MediaQuery.of(context).size.height * 0.015), // Boşluk ekleme
                      ElevatedButton(
                        onPressed: () {
                      ...
                      ElevatedButton.icon(
                        ...
                        icon: Icon(FontAwesomeIcons.google,
                            color: Colors.white), // Google ikonunu kullan
                        label: const Text("Google ile Giriş Yap"),
                        style: ElevatedButton.styleFrom(
                            backgroundColor: AppColor.favoriteButtonColor, // Google buton rengi
                            minimumSize: Size(double.infinity, 35)),
                      ),
                      SizedBox(height: MediaQuery.of(context).size.height * 0.015), // Boşluk ekleme
                      TextButton(
                        ...
                        child: Text(_isRegisterScreen
                            ? "Giriş Ekranına Dön"
                            : "Kayıt Ol", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                      ),
                      const Divider(), // Divider ekleyin
                      SizedBox(height: MediaQuery.of(context).size.height * 0.01), // Boşluk ekleme
                      InkWell(
                        onTap: () {},
